...
Public Class ProgProp
    ...
    Public Sub GetProgInvoicesEmail()
        ...
        Dim sdr As SqlDataReader
        Try
            sSQL = "select prm,val FROM PRM where prm in('INVOICES_EMAIL','BODY_RECREATE','BODY_RESEND','BODY','BODY_SYG','UNPAID_INVOICES_TABLE')"
            cmd = New SqlCommand(sSQL, CNDB)
            sdr = cmd.ExecuteReader()
            While sdr.Read()
    ...
    Public Sub SetProgInvoicesEmail(ByVal sValue As String, ByVal sValue2 As String, ByVal sValue3 As String, ByVal sValue4 As String, ByVal sValue5 As String,
                                    ByVal sValue6 As String, ByVal sValue7 As String)
        Dim sSQL As String
        Dim cmd As SqlCommand
        Try
