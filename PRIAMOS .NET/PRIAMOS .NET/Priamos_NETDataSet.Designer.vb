...
Partial Public Class Priamos_NETDataSet
    ...
    Partial Public Class vw_BDGDataTable
        ...
        Public Overloads Function Addvw_BDGRow( _
                    ...
                    ByVal isManaged As Boolean) As vw_BDGRow
    ...
    Partial Public Class vw_INDDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function Addvw_INDRow(ByVal ID As System.Guid, ByVal code As Integer, ByVal inhID As System.Guid, ByVal repName As String, ByVal amt As Decimal, ByVal modifiedBy As System.Guid, ByVal modifiedOn As Date, ByVal createdOn As Date, ByVal nam As String, ByVal fDate As Date, ByVal tDate As Date, ByVal name As String, ByVal owner_tenant As Boolean, ByVal calcCatID As System.Guid) As vw_INDRow
            Dim rowvw_INDRow As vw_INDRow = CType(Me.NewRow,vw_INDRow)
            Dim columnValuesArray() As Object = New Object() {ID, code, inhID, repName, amt, modifiedBy, modifiedOn, createdOn, nam, fDate, tDate, name, owner_tenant, calcCatID}
...
Namespace Priamos_NETDataSetTableAdapters
    ...
    Partial Public Class vw_BDGTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        ID, code, old_code, nam, AdrID, cmt, aam, iam, dts, dtu, iad, modif"& _ 
                ...
                " fPWD, fCusCode, fHkasp, fDeposit, isManaged"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            vw_BDG"
    ...
    Partial Public Class vw_INDTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        ID, code, inhID, repName, amt, modifiedBy, modifiedOn, createdOn, n"& _ 
                "am, fDate, tDate, name, owner_tenant, calcCatID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            vw_IND"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE  "& _ 
                "      (inhID = @inhID)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
    ...
    Partial Public Class vw_CALC_CATTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        ID, name"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            vw_CALC_CAT"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As Priamos_NETDataSet.vw_CALC_CATDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As Priamos_NETDataSet.vw_CALC_CATDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
    ...
    Partial Public Class AHPB_H1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        ID, mdt"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            AHPB_H"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (finalized = 1) AND ("& _ 
                "bdgID = @bdgid)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@bdgid", Global.System.Data.SqlDbType.UniqueIdentifier, 16, Global.System.Data.ParameterDirection.Input, 0, 0, "bdgID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
