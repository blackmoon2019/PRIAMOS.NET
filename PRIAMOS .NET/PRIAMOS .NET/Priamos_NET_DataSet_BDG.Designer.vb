...
Partial Public Class Priamos_NET_DataSet_BDG
    ...
    Partial Public Class vw_BDGDataTable
        ...
        Public Overloads Function Addvw_BDGRow( _
                    ...
                    ByVal KeysManager As String,  _
                    ByVal totDepositA As Decimal,  _
    ...
    Partial Public Class vw_FOLDER_CATDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Default ReadOnly Property Item(ByVal index As Integer) As vw_FOLDER_CATRow
            Get
    ...
    Partial Public Class vw_CCT_BANKSDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Default ReadOnly Property Item(ByVal index As Integer) As vw_CCT_BANKSRow
            Get
    ...
    Partial Public Class vw_PUBLIC_SDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Default ReadOnly Property Item(ByVal index As Integer) As vw_PUBLIC_SRow
            Get
...
Namespace Priamos_NET_DataSet_BDGTableAdapters
    ...
    Partial Public Class vw_BDGTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT ADR_Code, ADR_ID, ADR_Name, AdrID, AreaID, Area_Code, Area_CouID, Area_ID,"& _ 
                ...
                "ManageID, bSeperate, calB, calH, cmt, code, createdOn, dts, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"           eCounte"& _ 
                "r, eName, ePaymentCode, eServiceNum, fCounter, fCusCode, fDeposit, fHkasp, fName"& _ 
                ", fPWD, fPaymentCode, fServiceNum, fUN, hpb, hpc, iam, isManaged, lpcB, lpcH, ma"& _ 
                "nagerID, modifiedBy, modifiedOn, nam, old_code, prd, tacB, tacH, tk, wCounter, w"& _ 
                "Name, wRegisterNum, totDepositA, totDepositR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM   vw_BDG"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE (isManaged = "& _ 
            ...
            Me._commandCollection(2).CommandText = "SELECT ADR_Code, ADR_ID, ADR_Name, AdrID, AreaID, Area_Code, Area_CouID, Area_ID,"& _ 
                ...
                ", fPWD, fPaymentCode, fServiceNum, fUN, hpb, hpc, iam, isManaged, lpcB, lpcH, ma"& _ 
                "nagerID, modifiedBy, modifiedOn, nam, old_code, prd, tacB, tacH, tk, wCounter, w"& _ 
                "Name, wRegisterNum, totDepositA, totDepositR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM   vw_BDG"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE (ISNULL(isMan"& _ 
    ...
    Partial Public Class vw_INHTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, code, bdgID, fDate, tDate, modifiedBy, modifiedOn, createdOn, nam, cmt"& _ 
                ...
                "me, DebitCollectorName, colannouncement, DateOfCalculate, FromTransfer"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM   v"& _ 
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As Priamos_NET_DataSet_BDG.vw_INHDataTable, ByVal bdgID As System.Guid) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(bdgID,System.Guid)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
    ...
    Partial Public Class vw_FOLDER_CATTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As Priamos_NET_DataSet_BDG.vw_FOLDER_CATDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
    ...
    Partial Public Class vw_CCT_BANKSTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function FillBycctID(ByVal dataTable As Priamos_NET_DataSet_BDG.vw_CCT_BANKSDataTable, ByVal cctID As System.Guid) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
    ...
    Partial Public Class vw_PUBLIC_STableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT vw_PUBLIC_S.*"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM   vw_PUBLIC_S"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"where servicetypeID='E073DA5D-C428-4F03"& _ 
                "-88C3-9ACCC51EF812'"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT vw_PUBLIC_S.*"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM   vw_PUBLIC_S"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"where servicetypeID='F0EE8CF4-2778-4EF8"& _ 
                "-BCF3-225541551CE6'"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(3) = New Global.System.Data.SqlClient.SqlCommand()
            Me._commandCollection(3).Connection = Me.Connection
            Me._commandCollection(3).CommandText = "Select vw_PUBLIC_S.* from vw_PUBLIC_S where servicetypeID='F0EE8CF4-2778-4EF8-BCF"& _ 
                "3-225541551CE6' "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"and ID =( select top 1 fPublicServiceID from BMANAGE where bdg"& _ 
            ...
            Me._commandCollection(4).CommandText = "SELECT vw_PUBLIC_S.*"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM   vw_PUBLIC_S"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"where servicetypeID='61407200-4E84-4FC7"& _ 
                "-9B99-A60FC5F9821B'"
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As Priamos_NET_DataSet_BDG.vw_PUBLIC_SDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByElectricity(ByVal dataTable As Priamos_NET_DataSet_BDG.vw_PUBLIC_SDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByFysiko(ByVal dataTable As Priamos_NET_DataSet_BDG.vw_PUBLIC_SDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByFysikoBdgID(ByVal dataTable As Priamos_NET_DataSet_BDG.vw_PUBLIC_SDataTable, ByVal bdgID As Global.System.Nullable(Of Global.System.Guid)) As Integer
        ...
        Public Overloads Overridable Function GetDataByFysikoBdgID(ByVal bdgID As Global.System.Nullable(Of Global.System.Guid)) As Priamos_NET_DataSet_BDG.vw_PUBLIC_SDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(3)
            If (bdgID.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(bdgID.Value,System.Guid)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillByWater(ByVal dataTable As Priamos_NET_DataSet_BDG.vw_PUBLIC_SDataTable) As Integer
